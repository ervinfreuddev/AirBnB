...
function Header() {
    return (
        ...
        grid-cols-3 bg-white shadow-md p-5 md:px-10">
            {/* Left*/}
        <div className="relative flex items-center h-10 cursor-pointer my-auto"><Image src={logo} alt="logo"
            layout="fill"
            objectFit="contain"
            objectPosition="left"
        ...
        {/*Middle - search */}
            ...
            md:shadow-sm">
                ...
                <SearchIcon className="hidden md:inline-flex h-8
                 bg-red-400
                text-white rounded-full cursor-pointer md:mx-2" />
            </div>

            {/*Right */}
            <div className="flex items-center 
            space-x-4 justify-end text-gray-500">
                <p className="hidden md:inline cursor-pointer">become a hose </p>
